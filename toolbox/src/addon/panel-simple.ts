...
export function renderStencilPanel(element: HTMLElement, componentInfo: StencilComponentInfo | null): void {
  ...
  const headerStyle =
    'padding: 12px 16px; background-color: #f5f5f5; font-weight: 600; cursor: pointer; border-bottom: 1px solid #e0e0e0; display: flex; justify-content: space-between; align-items: center;';
